 ...
 <div>
    ...
    >
      ...
      <el-form-item prop="teacher">
        <el-input readonly v-model="search.teacher" placeholder="授课教师" @click.native="dialogTeacherVisible=true"></el-input>
      </el-form-item>
  ...
  <!-- 分页模板 -->
    ...
    <!-- 选择教师弹窗 -->
    <el-dialog title="选择教师" :visible.sync="dialogTeacherVisible" width="500px">
    ...
    <el-dialog title="学生编辑" :visible.sync="dialogFormVisible" width="500px">
      ...
      >
        ...
        <el-form-item prop="admissiondate" label="入学时间">
          <el-date-picker
        ...
        <el-form-item label="授课教师" prop="teacher">
          <el-input v-model="student.teacher" readonly @click.native="editOptionTeacher"></el-input>
        </el-form-item>
